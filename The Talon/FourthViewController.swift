...
//  The Talon
//
//  Created by Yanay Rosen on 1/2/16.
...
class FourthViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate {
    ...
    var apiKey = "AIzaSyBIOzIRWgsPqgB2ywX6_x4fUzb0ARDVDMA"
    
    var desiredChannelsArray = ["UCqQQqLRccehndeOTepS3DCw", "UCWpF3bwt-iEyTBwIR9QkM5g"]
